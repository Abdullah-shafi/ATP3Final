            ...
            <div class="row align-items-center h-100">
                <div class="col-12">
                    <div class="cta-content text-center">
                        ...
                        <a href="customer_home" class="btn south-btn mt-50 wow fadeInUp" data-wow-delay="500ms">Search</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- <?php  
 ...
 $query = "SELECT date, count(*) as number FROM property GROUP BY date  ORDER BY date DESC LIMIT 0, 5";  
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Aweb\try\laratest\resources\views/website/about-us.blade.php ENDPATH**/ ?>