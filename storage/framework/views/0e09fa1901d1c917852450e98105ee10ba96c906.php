        ...
        <div class="main-header-area" id="stickyHeader">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="southNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="<?php echo e(route('website.r_customer_home')); ?>"><h2 style="color:red">AB Property</h2></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                <li><a href="<?php echo e(route('website.r_customer_home')); ?>">Home</a></li>
                                 <li><a href="about">About</a></li>
                                <li><a href="#">Profile</a>
                                    <ul class="dropdown">
                                        <li><a href="<?php echo e(route('website.customer_about_me')); ?>">About Me</a></li>
                                        <li><a href="<?php echo e(route('website.customer_edit_profile')); ?>">Edit Profile</a></li>
                                        <li><a href="<?php echo e(route('website.customer_change_password')); ?>">Change Password</a></li>
...
</html><?php /**PATH C:\Users\Abdullah Shafi\Desktop\try\laratest\resources\views/layout/r_main.blade.php ENDPATH**/ ?>