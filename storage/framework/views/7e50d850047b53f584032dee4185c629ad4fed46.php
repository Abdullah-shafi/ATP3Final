...
<?php $__currentLoopData = $propertys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="property-thumb">
                            ...
                            <!-- <form method="" action="/customer_property_details/<?php echo e($property->property_id); ?>"> -->
                              ...
                              <!-- <button id="<?php echo e($property->property_id); ?>"> -->
                                <a href="/customer_property_details/<?php echo e($property->property_id); ?> ">
    ...
    <?php echo e($propertys->links()); ?>
           ...
           <center> <a href="customer_all_property" class="btn south-btn mt-50 wow fadeInUp" data-wow-delay="500ms">All Properties</a></center>
        </div>  
...
<!-- ##### Call To Action Area Start ##### -->
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/r_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Abdullah Shafi\Desktop\try\laratest\resources\views/website/r_customer_home.blade.php ENDPATH**/ ?>