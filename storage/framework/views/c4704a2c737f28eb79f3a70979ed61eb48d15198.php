            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Edit Prperty</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="property-thumb">
                            ...
                            <!-- <form method="" action="/customer_property_details/<?php echo e($property->property_id); ?>"> -->
                              ...
                              <!-- <button id="<?php echo e($property->property_id); ?>"> -->
                                <a href="/customer_edit_property_details/<?php echo e($property->property_id); ?> ">
...
<!-- ##### Call To Action Area Start ##### -->
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/r_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Abdullah Shafi\Desktop\try\laratest\resources\views/website/r_customer_edit_property.blade.php ENDPATH**/ ?>